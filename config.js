...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://i.postimg.cc/BQRLmRt5/d15613k-597c30bc-8d8b-4b47-8a17-249a48b9ea87.jpg Hi👋🏻 {sender},🔥Im The Marvin🔥 I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || '🔥The Marvin🔥;https://i.postimg.cc/BQRLmRt5/d15613k-597c30bc-8d8b-4b47-8a17-249a48b9ea87.jpg;https://chat.whatsapp.com/IXpzmHdHC3eLa0ZAtSnePH',
    RBG_KEY: process.env.RBG_KEY || 'Aditha',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'on',
    HANDLERS: process.env.HANDLERS || '.,*'/@:',
    STICKER_DATA: process.env.STICKER_DATA || "🔥The Marvin 🔥",
    BOT_NAME: process.env.BOT_NAME || '🔥The Marvin 🔥',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Owner= Adhitha✓;🔥The Marvin Bot🔥;https://i.postimg.cc/BQRLmRt5/d15613k-597c30bc-8d8b-4b47-8a17-249a48b9ea87.jpg' : process.env.AUDIO_DATA,
    TAKE_KEY: process.env.TAKE_KEY || 'Aditha',
    MODE: process.env.MODE || 'public',
    WARN: process.env.WARN || '4',
    ANTILINK_WARN: process.env.ANTILINK_WARN || 'https://chat.whatsapp.com/',
    HEROKU: {
    ...
    SUDO: process.env.SUDO || "https://api.whatsapp.com/send?phone=+94761585390",
